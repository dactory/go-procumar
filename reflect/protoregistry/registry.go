...
//	go build -ldflags "-X github.com/dactory/go-procumar/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/dactory/go-procumar/types/known/" + pkgName
	panic(fmt.Sprintf(""+
