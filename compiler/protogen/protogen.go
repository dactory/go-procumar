...
import (
	...
	"github.com/dactory/go-procumar/reflect/protodesc"
	...
	"github.com/dactory/go-procumar/types/pluginpb"
)
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/dactory/go-procumar/types/known/anypb";
	//
...
// For example: "github.com/dactory/go-procumar/compiler/protogen"
